package Terceiro_Periodo.lista_ex15.ex5;/*
Crie uma classe chamada ArmazenarVetor que contenha uma fun��o em Java que contenha um vetor
de inteiros 8x8 que dever� ser preenchido com valores aleat�rios. Crie m�todos que salvem somente
os dados destacados abaixo(de vermelho) em seus respectivos arquivos. Obs.: Os valores do vetor
ser�o preenchidos aleatoriamente entre 0 e 99.
 */
...
public class ArmazenarVetor {
    ...
    public static void saveInFile(int[] vetor) {
        ...
        try {
            ...
            System.out.println("N�o foi poss�vel salvar.");
        }
    }
}
