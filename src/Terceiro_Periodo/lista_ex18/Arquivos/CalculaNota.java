package Terceiro_Periodo.lista_ex18.Arquivos;// nome, matr�cula, s�rie, nota 1, nota 2 e nota 3.
//  0        1        2      3       4        5
...
public class CalculaNota extends ReadTXTDataBase {
    ...
    public static void writeAverages() {
        ...
        try (FileWriter fileWriter = new FileWriter(file)) {
            ...
            String averagesString = "Nome, Serie, M�dia\n";
            ...
            System.out.println("N�o foi poss�vel escrever.");
        }
    }
