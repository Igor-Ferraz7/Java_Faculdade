package exercicios_lista26.ex3;

/*
Crie em Java uma classe chamada Ordenar, que deverá ler o conteúdo do arquivo numeros.txt e
ordená-los em ordem DECRESCENTE. Após realizar a ordenação, substitua o conteúdo original do
arquivo pelos números ordenados. Exemplo:
        ...
        try (FileReader fileReader = new FileReader(file)){
            ...
            while ((charCode = fileReader.read()) != -1) {
                ...
                if (character != ',' && character != '\r' && character != '\n') {
                    numbers.append(character); //o erro está aqui! "numbers" esta recebendo muitos 1
                } else {
                    char cc = character;
                }
            }
