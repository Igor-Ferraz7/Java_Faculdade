...
o status da reserva (reservado ou não reservado) e o motivo caso não reservado;
 */
...
//                    System.out.println(ids_reservas_certas.get(i));
        ...
        //relacionar reservas que não puderam ser reservadas >> Está errado!!!
        /*
        for (int i = 0; i < reservaConflitos.size(); i++) {
    ...
    /*
        public static int getReserva_certa(List<Reserva_Conflito> temp_list) {
            ...
            for (int i = 0; i < temp_list.size() - 1; i++) {
                ...
                if (checkIn_atual_conflitou || checkOut_atual_conflitou) { //  > talvez a lógica não esteja 100% certa < \\
    ...
    public static void print_reserva_conflito2(List<Reserva_Conflito> reservaConflitos_sorted) {
        for (int i = 0; i < reservaConflitos_sorted.size(); i++) {
            ...
            if (status_reserva) {
                ...
                status_reserva_String = "Não reservado";
            }
            System.out.println("-----------------------------------------------------------------------------------------------------------------------------------");
...
o proximo id_local é igual?
    ...
    se não:
        ...
        se não houver o que comparar, mude o status para true
 */