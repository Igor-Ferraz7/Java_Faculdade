...
/*
 Crie em Java uma classe chamada Matriz. Essa classe deverá gerar de forma aleatória uma matriz de inteiros 5x5
com valores entre 1 e 100, porém os números não podem se repetir. Após gerar e preencher a matriz, deverão ser
salvos os dados das seguintes células destacadas(em vermelho) em um
arquivo chamado matriz.txt (este arquivo deve ser salvo na mesma pasta do projeto).

Bônus(+10,0): Utilizar classes separadas para manipular o arquivo e gerar matriz.
        - reomceNums
        - matrizToString
        - saveMatriz
Bônus(+ 5,0): Utilizar construtores nas classes.
Bônus(+ 5,0): Utilizar métodos especificos (gerar matriz, gerar arquivo, preencher, etc?).
*/
...
public class Matriz {
    ...
    // numeros aleatórios que não vão se repetir
